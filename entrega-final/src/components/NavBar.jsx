    ...
    <>
      ...
      <div className="navbar navbar-expand-lg navbar-dark float-top" id="nav">
        <div className="container-fluid">
          <Link to="/" className="navbarbrand" ><img src='https://www.netsurferlp.ar/curso_frontend/media/apple-touch-icon.png' className='rounded float-start'id="logo"/></Link>
          ...
          <div className="collapse navbar-collapse" id="navbarContent">
            ...
            <li className="nav-item">
                <Link to="/about" className="nav-link" id="link" >Sobre mi</Link>
              </li>


              <li className="nav-item">
                <Link to="/services" className="nav-link" id="link" >Servicios</Link>
              </li>
              <li className="nav-item">
                <Link to="/products" className="nav-link" id="link" >Productos</Link>
              </li>
            ...
            <div className="sm-mx-auto d-flex align-items-center gap-3">
              <ContenedorCart> 
                <IconoCart to="/pay" className="nav-link d-flex align-items-center" id="link">
              ...
              {isAuthenticated ? (
                <div className="d-flex align-items-center gap-3">
                  ...
                  {user.name === "admin" && (
                    <Link to="/adminpanel" className="nav-link " id="link">Admin Panel</Link>
                  )}
